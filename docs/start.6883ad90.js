...
exports.images = ['samples/1.jpg', 'samples/2.jpg', 'samples/3.jpg', 'samples/4.jpg', 'samples/5.jpg', 'samples/6.jpg', 'samples/7.jpg', 'samples/8.jpg', 'samples/9.jpg', 'samples/10.jpg', 'samples/11.jpg', 'samples/12.jpg', 'samples/13.jpg'];
...
var Tile = /** @class */function (_super) {
    ...
    Tile.prototype.render = function (_a) {
        var src = _a.src,
        ...
        return preact_1.h("li", { style: style });
    };
    return Tile;
}(preact_1.Component);
exports.Tile = Tile;
...
function arrayReplaceIn(src, target) {
    for (var i = 0; i < src.length; i++) {
        target[i] = src[i];
    }
}
exports.arrayReplaceIn = arrayReplaceIn;
function shuffleSlice(arr, start, end) {
    var shuffled = shuffle(arr.slice(start, end));
    return arrayReplaceIn(shuffled, arr);
}
exports.shuffleSlice = shuffleSlice;
function dummyArray(len) {
    return Array.apply(null, Array(len)).map(function (x) {
        return {
            x: 0,
            y: 0,
            width: 0,
...
function calculateSizes(nodes, splits, nextPower, minmax) {
    var n1,
        n2,
        parent,
        minFn = Math.min,
...
function searchSolution(width, height, aspectRatios, searchTime) {
    var BIG = 999999999;
    var targetRatio = width / height,
        ...
        nodes = aspectRatios.map(function (r, idx) {
        return {
            x: 0,
            y: 0,
            width: 0,
    ...
    var _loop_1 = function _loop_1() {
        ...
        if (currentDifference < minAspectRatioThreshold) {
            ...
            if (score < previousMinScore) {
                ...
                var arr = fullArray.slice(0, nextPower).filter(function (n) {
                    return !n.dummy;
                });
                winner = arr.map(function (n) {
                    return {
                        x: n.x,
                        y: n.y,
                        index: n.index,
                ...
                if (allowCropping) {
                    var scaleX_1 = width / last.width;
                    var scaleY_1 = height / last.height;
                    winner = winner.map(function (n) {
                        return {
                            x: n.x * scaleX_1,
                            y: n.y * scaleY_1,
                            index: n.index,
                            width: n.width * scaleX_1,
                            height: n.height * scaleY_1
                        };
                    });
                }
            }
...
exports.searchSolution = searchSolution;
...
require("./diorama.css");
var Diorama = /** @class */function (_super) {
    __extends(Diorama, _super);
    function Diorama(props) {
        var _this = _super.call(this, props) || this;
        _this.resizing = false;
        _this.crop = function () {
            _this.setState({ showCrop: !_this.state.showCrop });
            _this.forceUpdate();
        };
        _this.recalc = function () {
            _this.calculatePositions();
        };
        _this.add = function () {
            _this.setState({ images: Math.min(_this.props.images.length, _this.state.images + 1) });
            _this.calculatePositions();
        };
        _this.remove = function () {
            _this.setState({ images: Math.max(5, _this.state.images - 1) });
            _this.calculatePositions();
        };
        _this.state = {
            showCrop: false,
    ...
    Diorama.prototype.componentDidMount = function () {
        var _this = this;
    ...
    */
    Diorama.prototype.calculatePositions = function () {
        ...
        var w = this.base.clientWidth,
            ...
            positions = [];
        do {
            positions = layout_1.searchSolution(w, h, tiles.map(function (tile) {
                return tile.aspectRatio;
            }), 100);
        } while (!positions);
        requestAnimationFrame(function () {
            _this.setState({
                tileProps: positions.sort(function (a, b) {
                    return a.index - b.index;
                }).map(function (p) {
                    return {
                        src: _this.props.images[p.index].src,
                        aspectRatio: _this.props.images[p.index].aspectRatio,
                        top: p.y,
                        left: p.x,
                        width: p.width,
                        height: p.height
    ...
    Diorama.prototype.shouldComponentUpdate = function () {
        return false;
    };
    Diorama.prototype.render = function (props, _a) {
        var _this = this;
        var tileProps = _a.tileProps,
            showCrop = _a.showCrop,
            images = _a.images,
            state = __rest(_a, ["tileProps", "showCrop", "images"]);
        return preact_1.h("div", { className: "diorama " + (showCrop ? 'crop' : '') }, preact_1.h("ul", null, tileProps.map(function (props) {
            return preact_1.h(tile_1.Tile, __assign({}, props));
        })), preact_1.h("nav", null, preact_1.h("button", { class: "calc", onClick: function onClick() {
                return _this.recalc();
            } }, "Recalculate"), preact_1.h("button", { class: "crop-toggle", onClick: function onClick() {
                return _this.crop();
            } }, "Show crop"), preact_1.h("button", { class: "fullscreen", onClick: function onClick() {
                return screenfull_1.default.toggle();
            } }, "Fullscreen"), preact_1.h("button", { class: "add-image", onClick: function onClick() {
                return _this.add();
            } }, "Add"), preact_1.h("button", { class: "del-image", onClick: function onClick() {
                return _this.remove();
            } }, "Remove")));
    };
    return Diorama;
...
(function () {
    return __awaiter(_this, void 0, void 0, function () {
        var _a, loaded, imgWithRatios;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    return [4 /*yield*/, Promise.all([domReady].concat(images_1.images.map(imageLoader)))];
                case 1:
                    _a = _b.sent(), loaded = _a[0], imgWithRatios = _a.slice(1);
                    preact_1.render(preact_1.h(diorama_1.Diorama, { images: imgWithRatios }), document.body);
                    return [2 /*return*/];
            }
        });
    });
...
//# sourceMappingURL=/start.6883ad90.map